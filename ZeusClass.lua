...
do
	...
	function ZeusMod:SpawnStaticMEDIUMFOB(pos)
		...
		SPAWNSTATIC:InitType("outpost_road")
		:InitNamePrefix("Static Barrage routier")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(112, 269, false, false):GetVec2()), 270)

		SPAWNSTATIC:InitType("Container white")
		:InitNamePrefix("Container white")
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(126, 277, false, true):GetVec2()), 90)

		SPAWNSTATIC:InitType("Container white")
		:InitNamePrefix("Container white")
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(9, 0, false, true):GetVec2()), 90)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 30, false, true):GetVec2()), 0)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 30, false, true):GetVec2()), 90)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 60, false, true):GetVec2()), 0)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 120, false, true):GetVec2()), 90)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 150, false, true):GetVec2()), 0)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 120, false, true):GetVec2()), 70)

		SPAWNSTATIC:InitType("Container white")
		:InitNamePrefix("Container white")
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(9, 173, false, true):GetVec2()), 90)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 300, false, true):GetVec2()), 90)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 330, false, true):GetVec2()), 0)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(119, 28, false, true):GetVec2()), 90)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(27, 180, false, true):GetVec2()), 90)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 144, false, true):GetVec2()), 0)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(27, 270, false, true):GetVec2()), 90)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(27, 90, false, true):GetVec2()), 90)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(35, 111, false, true):GetVec2()), 0)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(47, 106, false, true):GetVec2()), 0)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 210, false, true):GetVec2()), 90)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(36, 180, false, true):GetVec2()), 90)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(63, 270, false, true):GetVec2()), 90)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(29, 90, false, true):GetVec2()), 0)
		...
		:InitShape("konteiner_white")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(197, 292, false, true):GetVec2()), 0)
		...
		SPAWNSTATIC:InitType("Shelter B")
		:InitNamePrefix("Static Abri B")
		:InitShape("ukrytie_b")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(16, 295, false, true):GetVec2()), 0)

		SPAWNSTATIC:InitType("T-90")
		:InitNamePrefix("Static Char T-90")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(9, 90, false, false):GetVec2()), 90)

		SPAWNSTATIC:InitType("Shelter B")
		:InitNamePrefix("Static Abri B")
		:InitShape("ukrytie_b")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 0, false, true):GetVec2()), 0)
		...
		:InitShape("ukrytie_b")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(23, 39, false, true):GetVec2()), 90)

		SPAWNSTATIC:InitType("Shelter B")
		:InitNamePrefix("Static Abri B")
		:InitShape("ukrytie_b")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 90, false, true):GetVec2()), 90)
		...
		SPAWNSTATIC:InitType("FARP Fuel Depot")
		:InitNamePrefix("Static FARP Dépot de carburant")
		:InitShape("GSM Rus")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(8, 107, false, true):GetVec2()), 90)

		SPAWNSTATIC:InitType("GeneratorF")
		:InitNamePrefix("Static Générateur F")
		:InitShape("GeneratorF")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(13, 143, false, true):GetVec2()), 90)

		SPAWNSTATIC:InitType("GeneratorF")
		:InitNamePrefix("Static Générateur F")
		:InitShape("GeneratorF")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(26, 90, false, true):GetVec2()), 90)

		SPAWNSTATIC:InitType("GeneratorF")
		:InitNamePrefix("Static Générateur F")
		:InitShape("GeneratorF")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(46, 90, false, true):GetVec2()), 270)

		SPAWNSTATIC:InitType("GeneratorF")
		:InitNamePrefix("Static Générateur F")
		:InitShape("GeneratorF")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(67, 180, false, true):GetVec2()), 270)

		SPAWNSTATIC:InitType("GeneratorF")
		:InitNamePrefix("Static Générateur F")
		:InitShape("GeneratorF")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(46, 270, false, true):GetVec2()), 90)

		SPAWNSTATIC:InitType("GeneratorF")
		:InitNamePrefix("Static Générateur F")
		:InitShape("GeneratorF")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(26, 270, false, true):GetVec2()), 90)

		SPAWNSTATIC:InitType("Mi-24V")
		:InitNamePrefix("Static Mi-24V")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(14, 35, false, true):GetVec2()), 0)

		SPAWNSTATIC:InitType("Mi-24V")
		:InitNamePrefix("Static Mi-24V")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(27, 90, false, true):GetVec2()), 0)
		...
		:InitNamePrefix("Static Mi-24V")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(42, 0, false, true):GetVec2()), 180)

		SPAWNSTATIC:InitType("Mi-24V")
		:InitNamePrefix("Static Mi-24V")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(27, 270, false, true):GetVec2()), 180)
		...
		SPAWNSTATIC:InitType("house1arm")
		:InitNamePrefix("Static Caserne armée")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(96, 86, false, true):GetVec2()), 0)

		SPAWNSTATIC:InitType("Infantry AK ver2")
		:InitNamePrefix("Static Infantry AK-74 Rus ver2")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(14, 190, false, false):GetVec2()), 180)

		SPAWNSTATIC:InitType("Infantry AK ver2")
		:InitNamePrefix("Static Infantry AK-74 Rus ver2")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(14, 170, false, false):GetVec2()), 180)

		SPAWNSTATIC:InitType("UAZ-469")
		:InitNamePrefix("Static LUV UAZ-469")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(15, 133, false, false):GetVec2()), 200)

		SPAWNSTATIC:InitType("UAZ-469")
		:InitNamePrefix("Static LUV UAZ-469")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(17, 126, false, false):GetVec2()), 200)

		SPAWNSTATIC:InitType("UAZ-469")
		:InitNamePrefix("Static LUV UAZ-469")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(19, 121, false, false):GetVec2()), 200)

		SPAWNSTATIC:InitType("UAZ-469")
		:InitNamePrefix("Static LUV UAZ-469")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(21, 117, false, false):GetVec2()), 200)

		SPAWNSTATIC:InitType("houseA_arm")
		:InitNamePrefix("Static Building armed")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(33, 210, false, true):GetVec2()), 0)

		SPAWNSTATIC:InitType("Infantry AK ver2")
		:InitNamePrefix("Static Infantry AK-74 Rus ver2")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(8, 85, false, false):GetVec2()), 90)

		SPAWNSTATIC:InitType("Military staff")
		:InitNamePrefix("Static Equipement militaire")
		:InitShape("aviashtab")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(20, 120, false, true):GetVec2()), 180)

		SPAWNSTATIC:InitType("Infantry AK ver2")
		:InitNamePrefix("Static Infantry AK-74 Rus ver2")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 340, false, false):GetVec2()), 0)

		SPAWNSTATIC:InitType("Infantry AK ver2")
		:InitNamePrefix("Static Infantry AK-74 Rus ver2")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(7, 20, false, false):GetVec2()), 0)

		SPAWNSTATIC:InitType("Ural-4320T")
		:InitNamePrefix("Static Truck Ural-4320T")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(11, 90, false, false):GetVec2()), 0)

		SPAWNSTATIC:InitType("Ural-4320T")
		:InitNamePrefix("Static Truck Ural-4320T")
		:InitCountry(country.id.RUSSIA)
		:SpawnFromPointVec2(POINT_VEC2:NewFromVec2(coord:Translate(14, 90, false, false):GetVec2()), 0)

		self:Spawn("Z_Ural", POINT_VEC3:NewFromVec3(coord:Translate(17,90, false, false):GetVec3()), 0)
